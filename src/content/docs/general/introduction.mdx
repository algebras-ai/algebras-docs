...
Translates the given text to the target language. Sent as `multipart/form-data` — see the [Translation API reference](/api/translation/translate/) for the full field list.
