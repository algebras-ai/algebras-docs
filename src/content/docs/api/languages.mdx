...
**Endpoint:** <a href="https://platform.algebras.ai/api/v1#/Languages/post_translation_languages_detect" target="_blank" rel="noopener noreferrer"><code>POST /translation/languages/detect</code></a>
